    ...
    <div className="flex bg-gradient-to-b from-[#F8FAFC] to-[#F1F5F9] text-[#1E293B] dark:text-white min-h-screen" id="saas-app-root">
      ...
      <div className="w-64 hidden md:flex bg-white dark:bg-slate-900 border-r border-[#E2E8F0] text-[#475569] shadow-sm dark:shadow-none z-10 flex flex-col pt-5 shrink-0" id="saas-sidemenu">
        <div className="px-6 pb-6 border-b border-[#E2E8F0] flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-[#2563EB] flex items-center justify-center text-white font-display tracking-tight font-bold text-sm tracking-tight shadow-sm dark:shadow-none">
            C
          </div>
          <div>
            <div className="font-display tracking-tight font-bold text-slate-900 dark:text-white tracking-tight leading-none text-base">ComplianceOS</div>
        ...
        <div className="p-4 mx-3 my-4 rounded-xl bg-white dark:bg-slate-900 border border-[#E2E8F0] shadow-xs">
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Dubai Mainland • 15 FTEs</div>
          <div className="mt-3">
        ...
        <div className="p-3 border-t border-[#E5E7EB] bg-[#F8FAFC] dark:bg-slate-950">
          <div className="flex items-center gap-3 bg-white dark:bg-slate-800 border border-[#E2E8F0] dark:border-slate-700 p-3 rounded-xl shadow-sm dark:shadow-none flex-1">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold truncate text-slate-900 dark:text-white leading-tight">Mark Channa</p>
      ...
      <div className="flex-1 flex flex-col p-8 overflow-y-auto max-h-[1000px]" id="saas-main-workspace">
        ...
        <div className="flex justify-between items-center pb-6 border-b border-slate-200 dark:border-slate-700 mb-6" id="saas-topbar">
          <div>
            <span className="text-xs text-slate-400 uppercase tracking-widest font-mono-ui">Operations Portal</span>
            <h1 className="text-2xl font-display tracking-tight font-bold text-slate-900 dark:text-white tracking-tight">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-700 px-3 py-1.5 rounded-lg text-xs font-medium text-slate-700 dark:text-slate-200 transition cursor-pointer relative">
        ...
        {activeTab === "dashboard" && (
          <div className="space-y-6" id="saas-tab-dashboard">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-slate-900 p-8 rounded-2xl border border-[#E2E8F0] shadow-sm dark:shadow-none">
              ...
              <div className="flex items-center gap-2 bg-white dark:bg-slate-900/70 px-4 py-2.5 rounded-full border border-slate-150 shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
                ...
                <div className="flex -space-x-2">
                  ...
                  <button 
                    onClick={() => setActiveTab("visas")}
                    className="w-7 h-7 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-250 border-2 border-white flex items-center justify-center text-slate-500 dark:text-slate-400 font-display tracking-tight font-bold text-xs transition shadow-xs"
                  >
                    +
                  </button>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fadeUp stagger-1">
              ...
              <div className="bg-white dark:bg-slate-900 p-7 rounded-2xl border border-[#E2E8F0] shadow-sm dark:shadow-none bg-white dark:bg-slate-900 flex flex-col justify-between shadow-xs">
                <div>
                  <div className="flex justify-between items-start">
                    <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-mono-ui border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/50 px-2 py-1 rounded inline-block mb-2">STATE CHECK</span>
              ...
              <div className="bg-white dark:bg-slate-900 border border-[#E2E8F0] p-7 rounded-2xl flex flex-col justify-between shadow-sm dark:shadow-none relative overflow-hidden group">
                {/* Abstract light aura decoration */}
                <span className="absolute top-0 right-0 w-36 h-36 bg-white dark:bg-slate-900/5 rounded-full blur-2xl -mr-10 -mt-10 group-hover:bg-white dark:bg-slate-900/10 transition duration-500"></span>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h4 className="font-display tracking-tight font-bold text-xs text-slate-900 dark:text-white uppercase tracking-wider mt-0.5">COMPLIANCE LEDGER</h4>
                  </div>
                  {/* Credit Card Chip Graphic Symbol */}
                  <div className="w-7 h-5 rounded bg-slate-200 dark:bg-slate-700 relative overflow-hidden border border-amber-300 shadow-xs">
                ...
                <div className="my-6">
                  <span className="text-slate-500 dark:text-slate-400 text-[9px] tracking-wider uppercase block font-mono-ui">DED Mainland Trade License</span>
                  <span className="text-lg font-mono-ui font-display tracking-tight font-bold tracking-widest block text-slate-900 dark:text-white mt-0.5">DET-847291-EXP</span>
                </div>
                ...
                <div className="flex justify-between items-end border-t border-slate-100 dark:border-slate-800 pt-3">
                  <div>
                    ...
                    <span className="font-display tracking-tight font-bold text-xs text-white">100293184729...</span>
                  </div>
              ...
              <div className="bg-white dark:bg-slate-900 p-7 rounded-2xl border border-[#E2E8F0] shadow-sm dark:shadow-none bg-white dark:bg-slate-900 flex flex-col justify-between shadow-xs">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-mono-ui border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/50 px-2 py-1 rounded inline-block mb-2">ANALYTICS ACCENT</span>
                ...
                <div className="flex items-center gap-6 my-auto pt-2 pb-1">
                  ...
                  <div className="relative w-24 h-24 shrink-0">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="text-xl font-display tracking-tight font-bold text-slate-900 dark:text-white tracking-tighter leading-none">{getComplianceScore()}%</span>
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex items-center gap-1.5 font-medium">
                      ...
                      <span className="text-slate-600 dark:text-slate-300">Active Approved ({getComplianceScore()}%)</span>
                    </div>
                    <div className="flex items-center gap-1.5 font-medium">
                      <span className="w-2 h-2 rounded-full bg-amber-400"></span>
                      <span className="text-slate-600 dark:text-slate-300">Pending Actions</span>
                    </div>
                    <div className="flex items-center gap-1.5 font-medium">
                      <span className="w-2 h-2 rounded-full bg-rose-500"></span>
                      <span className="text-slate-600 dark:text-slate-300">Unsettled Warnings</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-white dark:bg-slate-900 p-7 rounded-2xl border border-[#E2E8F0] shadow-sm dark:shadow-none bg-white dark:bg-slate-900 shadow-xs space-y-4">
                <div className="flex justify-between items-center pb-2 border-b border-slate-100 dark:border-slate-800">
                  <div>
                    <h3 className="font-display tracking-tight font-bold text-slate-900 dark:text-white text-sm">Recent Government Audit Logs</h3>
                ...
                <div className="space-y-4 pt-1">
                  {[
                    ...
                    <div key={idx} className="flex justify-between items-start md:items-center p-3 hover:bg-slate-50 dark:bg-slate-800/50/50 rounded-xl transition border border-transparent hover:border-slate-100 dark:border-slate-800">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-full font-black text-xs flex items-center justify-center shrink-0 ${log.bg}`}>
                          {log.portal}
                        </div>
                        <div>
                          <h4 className="font-display tracking-tight font-bold text-slate-900 dark:text-white text-xs">{log.name}</h4>
                          <span className="text-[11px] text-slate-500 dark:text-slate-400 block">{log.desc}</span>
                        </div>
                      </div>

                      <div className="text-right">
                        <span className="text-[11px] font-display tracking-tight font-bold text-slate-900 dark:text-white block font-mono-ui">{log.sum}</span>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-slate-900 p-7 rounded-2xl border border-[#E2E8F0] shadow-sm dark:shadow-none bg-white dark:bg-slate-900 shadow-xs">
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="font-display tracking-tight font-bold text-slate-900 dark:text-white text-xs uppercase tracking-wide">WPS Salary Compliance</h3>
                ...
                <div className="bg-[#F8FAFC] dark:bg-slate-950 border border-[#E2E8F0] p-7 rounded-2xl text-slate-900 dark:text-white shadow-sm dark:shadow-none flex flex-col justify-between relative overflow-hidden group">
                  ...
                  <div>
                    ...
                    <h4 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white">Need Offline PRO Representation?</h4>
                  ...
                  <button 
                    onClick={() => setActiveTab("chat")}
                    className="mt-6 w-full bg-white dark:bg-slate-900 border border-[#E2E8F0] hover:bg-slate-50 dark:bg-slate-800/50 text-slate-900 dark:text-white font-display tracking-tight font-bold text-xs py-2.5 px-4 rounded-xl transition text-center shadow-xs"
                  >
                    Ask AI Co-Counsel
                  </button>
                </div>
            ...
            <div className="p-6 bg-white dark:bg-slate-900 border border-[#E2E8F0] animate-fadeUp stagger-4 premium-card rounded-2xl p-7 shadow-xs relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-slate-50 dark:bg-slate-800/50 rounded-full blur-2xl -mr-10 -mt-10"></div>
              
              <h2 className="text-base font-display tracking-tight font-bold text-slate-900 dark:text-white mb-1 flex items-center gap-1.5">
                <Sparkles className="w-4 h-4 text-[#2563EB]" />
              ...
              {scanning ? (
                <div className="p-8 border-2 border-dashed border-blue-200 bg-blue-50/20 rounded-2xl flex flex-col items-center justify-center">
                  ...
                  <span className="text-sm font-display tracking-tight font-bold text-slate-800 dark:text-slate-100">Processing regulatory legal compliance check...</span>
                  <span className="text-xs text-slate-400 mt-1">Simulating FTA state server connection...</span>
                </div>
              ) : (
                <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 hover:border-[#2563EB] bg-slate-50 dark:bg-slate-800/50/50 hover:bg-white dark:bg-slate-900 rounded-2xl p-8 text-center transition cursor-pointer group relative">
                  <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 group-hover:bg-blue-50 flex items-center justify-center mx-auto mb-3 transition">
                    <Upload className="w-5 h-5 text-slate-400 group-hover:text-[#2563EB]" />
                  </div>
                  <span className="text-xs font-display tracking-tight font-bold text-slate-800 dark:text-slate-100">Drag & drop or <span className="text-[#2563EB] underline">select a file to upload</span></span>
                ...
                <div className="mt-4 p-4 border border-emerald-100 bg-emerald-50/20 rounded-xl">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <h4 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white mt-1">{scanResult.title}</h4>
                    </div>
                    <CheckCircle2 className="w-5 h-5 text-emerald-600" />
                  </div>
                  
                  <div className="grid grid-cols-2 gap-4 text-xs xl:grid-cols-3 mt-3 border-t border-slate-100 dark:border-slate-800 pt-3">
                      ...
                      <ul className="mt-1.5 space-y-2">
                        {scanResult.auditIssues.map((issue: any, i: number) => (
                          <li key={i} className="text-xs bg-rose-50/50 border border-rose-100 p-2.5 rounded-lg flex gap-2">
                            ...
                            <div>
                              <span className="font-semibold text-slate-900 dark:text-white block">{issue.message}</span>
                              <span className="text-slate-500 dark:text-slate-400 block mt-0.5">Remedy: {issue.remedy}</span>
                            </div>
                          </li>
                        ))}
                      </ul>
            ...
            <div className="p-6 bg-white dark:bg-slate-900 border border-[#E2E8F0] rounded-[1.75rem] shadow-xs">
              ...
              <div className="space-y-3">
                {tasks.filter(t => t.status === "pending").slice(0, 3).map(task => (
                  <div key={task.id} className="p-4 border border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:border-slate-700 rounded-xl flex items-start gap-4 transition hover:bg-slate-50 dark:bg-slate-800/50/30">
                    <input 
                      type="checkbox" 
                    ...
                    <div className="flex-1">
                      ...
                      <h4 className="font-semibold text-xs text-slate-900 dark:text-white mt-1">{task.title}</h4>
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">{task.description}</p>
                    </div>
                    <span className="text-[10px] font-mono-ui font-display tracking-tight font-bold text-slate-400 self-center bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 px-2 py-1 rounded">
                      {task.category}
                    </span>
                  </div>
                ))}
                ...
                {tasks.filter(t => t.status === "pending").length === 0 && (
                  <div className="p-8 border border-dashed border-slate-100 dark:border-slate-800 rounded-xl text-center">
        ...
        {activeTab === "tasks" && (
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm dark:shadow-none p-6" id="saas-tab-tasks">
            
            {/* New Task Creator Form */}
            <form onSubmit={handleAddTask} className="mb-8 p-5 bg-white dark:bg-slate-900 border border-[#E2E8F0] shadow-sm dark:shadow-none rounded-2xl p-6 space-y-4">
              <h3 className="text-sm font-display tracking-tight font-bold text-slate-900 dark:text-white flex items-center gap-1.5 leading-none">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-emerald-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-emerald-500 animate-none cursor-pointer"
                  />
                </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-100 dark:border-slate-800 text-slate-500 dark:text-slate-400 text-[10px] font-mono-ui uppercase tracking-wider">
                ...
                <tbody className="text-sm">
                  {tasks.map(task => (
                    <tr key={task.id} className="border-b border-slate-50 hover:bg-slate-50 dark:bg-slate-800/50/50 group transition">
                      ...
                      <td className="py-4 px-2">
                        <div>
                          <span className={`font-semibold ${task.status === "completed" ? "line-through text-slate-400 font-normal" : "text-slate-900 dark:text-white"}`}>
                            {task.title}
                          </span>
                          <p className="text-xs text-slate-400 mt-0.5 max-w-sm line-clamp-1">{task.description}</p>
                        </div>
                      </td>
                      <td className="py-4 px-4 font-medium text-slate-700 dark:text-slate-200">{task.category}</td>
        ...
        {activeTab === "calendar" && (
          <div className="space-y-6" id="saas-tab-calendar">
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm dark:shadow-none p-6">
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                {/* June 2026 Panel */}
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 bg-white dark:bg-slate-900 shadow-sm dark:shadow-none">
                  <div className="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-2 mb-3">
                    <h3 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white">June 2026</h3>
                  ...
                  <div className="space-y-3 min-h-[220px]">
                    {tasks
                      ...
                      .map(t => (
                        <div key={t.id} className="p-3 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-2 rounded-lg text-xs leading-relaxed">
                          <div className="flex justify-between items-center mb-1">
                          ...
                          <span className="text-[10px] text-slate-500 dark:text-slate-400">{t.category} • Assigner: {t.assignedTo.split(' ')[0]}</span>
                        </div>
                      ))}
                ...
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 bg-white dark:bg-slate-900 shadow-sm dark:shadow-none">
                  <div className="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-2 mb-3">
                    <h3 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white">July 2026</h3>
                ...
                <div className="border border-slate-250 border-dashed rounded-xl p-4 bg-white dark:bg-slate-900 shadow-sm dark:shadow-none">
                  <div className="flex justify-between items-center border-b border-slate-100 dark:border-slate-800 pb-2 mb-3">
                    <h3 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white">Q3 Roadmap (Aug-Sep)</h3>
        ...
        {activeTab === "inbox" && (
          <div className="grid grid-cols-3 gap-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm dark:shadow-none min-h-[500px]" id="saas-tab-inbox">
              ...
              <div className="divide-y divide-slate-100 overflow-y-auto max-h-[440px]">
                {notices.map(notice => (
                  <div 
                    ...
                    className={`p-4 cursor-pointer hover:bg-slate-50 dark:bg-slate-800/50/50 transition ${
                      selectedNotice?.id === notice.id ? "bg-emerald-50/20 border-l-4 border-emerald-500" : ""
                    }`}
                  >
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-xs font-mono-ui font-display tracking-tight font-bold text-slate-700 dark:text-slate-200">{notice.sender}</span>
                      <span className="text-[10px] text-slate-400 font-mono-ui">{notice.date}</span>
                    </div>
                    <h4 className="font-semibold text-sm text-slate-900 dark:text-white truncate">{notice.subject}</h4>
                    <p className="text-xs text-slate-500 dark:text-slate-400 line-clamp-2 mt-1">{notice.body}</p>
                  </div>
                ))}
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-start border-b border-slate-100 dark:border-slate-800 pb-4">
                    <div>
                      ...
                      <h2 className="text-lg font-display tracking-tight font-bold text-slate-900 dark:text-white mt-2">{selectedNotice.subject}</h2>
                  ...
                  <div className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700/50 font-serif whitespace-pre-wrap">
                    {selectedNotice.body}
                  </div>

                  <div className="p-4 border border-slate-200 dark:border-slate-700 bg-amber-50/20 rounded-xl space-y-2">
                    <span className="text-xs font-display tracking-tight font-bold text-slate-900 dark:text-white uppercase tracking-wider block">Action Checklist Mandated:</span>
                    <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">{selectedNotice.actionRequired}</p>
                    
                    {/* Draft Reply Area */}
                    {draftingReply ? (
                      <div className="mt-4 border-t border-slate-200 dark:border-slate-700 pt-3">
                        <span className="text-xs font-display tracking-tight font-bold text-slate-900 dark:text-white flex items-center gap-1 mb-2">
                          <Sparkles className="w-3.5 h-3.5 text-emerald-500" />
                          ComplianceOS AI Legal Response Agent Draft:
                        </span>
                        <textarea 
                          className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg p-3 text-xs focus:outline-none focus:border-emerald-500 font-mono-ui"
                          rows={6}
                          value={draftingReply}
                        ...
                        <div className="flex justify-end gap-2 mt-2">
                          <button 
                            ...
                            className="bg-[#10B981] hover:bg-[#059669] shadow-sm dark:shadow-none text-white font-medium text-xs px-3.5 py-2 rounded-lg flex items-center gap-1"
                          >
        ...
        {activeTab === "vault" && (
          <div className="space-y-6" id="saas-tab-vault">
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm dark:shadow-none p-6">
              ...
              <div className="flex md:flex-row flex-col justify-between items-start md:items-center gap-4 border-b border-slate-100 dark:border-slate-800 pb-6 mb-6">
                <div>
                  <h3 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white">Company Document Index Ledger</h3>
                ...
                <div className="flex items-center gap-2 relative">
                  <div className="bg-[#10B981] hover:bg-[#059669] shadow-sm dark:shadow-none text-white font-medium text-xs py-2 px-4 rounded-lg flex items-center gap-1.5 transition cursor-pointer">
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-1.5">
                    {[
                      ...
                      <div key={index} className="p-3 border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-800 rounded-xl flex justify-between items-center text-xs ml-1 cursor-pointer">
                        <span className="font-semibold text-slate-800 dark:text-slate-100">{fol.name}</span>
                        <span className="font-mono-ui text-[10px] bg-slate-200 dark:bg-slate-700 px-1.5 py-0.5 rounded text-slate-600 dark:text-slate-300 font-display tracking-tight font-bold">{fol.count}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="col-span-2 space-y-3">
                  ...
                  {docs.map(doc => (
                    <div key={doc.id} className="p-4 border border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-between transition gap-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h5 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white">{doc.name}</h5>
                          ...
                          {doc.extractedFields && (
                            <div className="mt-2 flex flex-wrap gap-1.5">
                              {Object.entries(doc.extractedFields).slice(0, 2).map(([k, v]: any) => (
                                <span key={k} className="text-[10px] bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded">
                                  {k.replace(/([A-Z])/g, ' $1')}: <strong className="text-slate-800 dark:text-slate-100">{v}</strong>
                                </span>
                              ))}
                            </div>
                          )}
        ...
        {activeTab === "visas" && (
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm dark:shadow-none p-6" id="saas-tab-visas">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white">MoHRE Employee Visa & Payroll Audit</h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="text-sm">
                  {employees.map(emp => (
                    <tr key={emp.id} className="border-b border-slate-50 hover:bg-slate-50 dark:bg-slate-800/50/50 transition">
                      <td className="py-4 px-2 font-display tracking-tight font-bold text-slate-900 dark:text-white">
                        <div>
                          <span>{emp.name}</span>
                      ...
                      <td className="py-4 px-4 font-semibold text-slate-800 dark:text-slate-100">AED {emp.salary.toLocaleString()}</td>
                      <td className="py-4 px-4">
                        <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded ${
                      ...
                      <td className="py-4 px-4 text-right">
                        {emp.wpsStatus !== "Paid" ? (
                          <button 
                            ...
                            className="bg-[#1E293B] hover:bg-slate-800 text-white shadow-sm dark:shadow-none font-medium text-[11px] py-1.5 px-3 rounded-lg transition"
                          >
        ...
        {activeTab === "chat" && (
          <div className="grid grid-cols-4 gap-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm dark:shadow-none min-h-[500px]" id="saas-tab-chat">
            
            {/* Left Prompt Guide Rails */}
            <div className="border-r border-slate-100 dark:border-slate-800 p-5 space-y-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <button
                    ...
                    className="w-full text-left p-2.5 border border-slate-100 dark:border-slate-800 hover:border-emerald-100 hover:bg-emerald-50/5 text-xs rounded-xl flex items-center justify-between group transition"
                  >
                    <div>
                      <span className="text-[10px] text-slate-400 block font-mono-ui uppercase">{chip.label}</span>
                      <p className="font-semibold text-slate-700 dark:text-slate-200 leading-tight mt-0.5 line-clamp-2">{chip.q}</p>
                    </div>
            ...
            <div className="col-span-3 flex flex-col justify-between" id="chat-frame-container">
              ...
              <div className="p-6 space-y-4 flex-1 overflow-y-auto max-h-[380px]">
                  ...
                  <div key={i} className={`flex gap-3 max-w-full ${msg.role === "user" ? "justify-end" : ""}`}>
                    ...
                    <div className={`p-4 rounded-2xl text-xs leading-relaxed max-w-md xl:max-w-xl ${
                      ...
                      {msg.role === "user" ? (
                        ...
                        msg.content.split('\n').map((line, key) => {
                          if (line.startsWith('### ')) {
                            return <h3 key={key} className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white mt-2 mb-1 border-b border-slate-100 dark:border-slate-800 pb-0.5">{line.substring(4)}</h3>;
                          }
                          if (line.startsWith('1. ') || line.startsWith('2. ') || line.startsWith('3. ') || line.startsWith('4. ')) {
                            return <p key={key} className="pl-2 font-serif text-slate-700 dark:text-slate-200 font-medium ml-1 my-1.5">{line}</p>;
                          }
                ...
                {chatLoading && (
                  <div className="flex gap-3">
                    ...
                    <div className="p-4 bg-slate-100 dark:bg-slate-800 rounded-2xl rounded-tl-none text-xs flex items-center gap-2">
              ...
              <form onSubmit={handleSendChatMessage} className="p-4 border-t border-slate-100 dark:border-slate-800 flex gap-2">
                <input 
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-xs focus:outline-none focus:bg-white dark:bg-slate-900 focus:border-emerald-500 placeholder-slate-400 shadow-inner"
                />
                <button type="submit" className="bg-[#1E293B] hover:bg-slate-800 text-white shadow-sm dark:shadow-none font-medium text-xs px-5 rounded-xl flex items-center gap-1">
                  Ask AI
                </button>
              </form>
        ...
        {activeTab === "profile" && (
          <div className="grid grid-cols-3 gap-6" id="saas-tab-profile">
            ...
            {/* Main Info Registry */}
            <div className="col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm dark:shadow-none p-6 space-y-6">
              <div>
                <h3 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white border-b border-slate-100 dark:border-slate-800 pb-2 mb-4">DET Corporate Registry Profile</h3>
              ...
              <div>
                <h3 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white border-b border-slate-100 dark:border-slate-800 pb-2 mb-4">Federal Tax Profile</h3>
              ...
              <div>
                <h3 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white border-b border-slate-100 dark:border-slate-800 pb-2 mb-4">Shareholder Registry (UBO Record)</h3>
                ...
                <div className="space-y-2.5">
                  {[
                    ...
                    <div key={idx} className="flex justify-between items-center text-xs p-3 border border-slate-100 dark:border-slate-800 rounded-xl">
                      <div>
                        <span className="font-display tracking-tight font-bold text-slate-800 dark:text-slate-100 block text-sm">{sh.name}</span>
                        <span className="text-slate-400 block mt-0.5">{sh.role} • Nationality: {sh.country}</span>
                      </div>
                      <span className="text-slate-900 dark:text-white font-mono-ui font-display tracking-tight font-bold text-sm">{sh.equity}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm dark:shadow-none p-6">
                <h4 className="font-display tracking-tight font-bold text-sm text-slate-900 dark:text-white mb-3 uppercase tracking-wider text-[11px] text-slate-400">Government Portal Connections</h4>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="p-3 border border-slate-150/60 bg-slate-50 dark:bg-slate-800/50/20 rounded-xl flex justify-between items-center text-xs">
                      <div>
                        <span className="font-display tracking-tight font-bold text-slate-800 dark:text-slate-100 block">{int.name}</span>
